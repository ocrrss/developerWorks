...
public class ScoringOffense extends AbstractStrategy {
  
  private static final Logger LOG = Logger.getLogger(ScoringOffense.class);
  ...
  public String generateSql(String year, List<String[]> data) {
    ...
    for (String[] line : data) {
      ...
      String sql = "INSERT INTO " + /*SCHEMA_NAME + "." +*/ TABLE_NAME + "(" +
          "YEAR, TEAM_NAME, NUM_GAMES, NUM_POINTS, AVG_POINTS_PER_GAME)"
          + "VALUES(" +
