...
public class ThreePointFieldGoalsPerGame extends AbstractStrategy {

  private static final Logger LOG = Logger.getLogger(ThreePointFieldGoalsPerGame.class);
  ...
  public String generateSql(String year, List<String[]> data) {
    ...
    for (String[] line : data) {
      ...
      BigDecimal pgPct = BigDecimal.valueOf((double)numMade/numGames).setScale(5,  RoundingMode.HALF_UP);
      String sql = "INSERT INTO " + /*SCHEMA_NAME + "." +*/ TABLE_NAME + "(" +
          "YEAR, TEAM_NAME, NUM_GAMES, NUM_3P_MADE, NUM_3P_PER_GAME)"
          + "VALUES(" +
